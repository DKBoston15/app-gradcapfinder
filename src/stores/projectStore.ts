    ...
    (set) => ({
      ...
      addProject: async (name) => {
        ...
        set((state) => ({
          projects: [
            ...state.projects,
            { id: data[0].id, name, start_date: data[0].start_date, user_id: user.id },
          ],
        }));
        return data[0].id;
      },
      ...
      deleteProject: async (id) => {
        ...
        const setGetAll = useGeneralStore.getState().setGetAll;
        setGetAll();
      },
      ...
      archiveProject: async (id) => {
        ...
        set((state) => ({
          projects: state.projects.map((project) =>
            project.id === id ? { ...project, completed_at: data[0].archived_at } : project,
          ),
        }));
      },
      ...
      completeProject: async (id) => {
        ...
        set((state) => ({
          projects: state.projects.map((project) =>
            project.id === id ? { ...project, completed_at: data[0].completed_at } : project,
          ),
        }));
      },
      ...
      updateObjective: async (id, objectives) => {
        ...
        set((state) => ({
          projects: state.projects.map((project) =>
            project.id == id ? { ...project, objectives } : project,
          ),
        }));
      },
      ...
      updateActivity: async (id, activities) => {
        ...
        set((state) => ({
          projects: state.projects.map((project) =>
            project.id === id ? { ...project, activities } : project,
          ),
        }));
      },
      ...
      updateProduct: async (id, products) => {
        ...
        set((state) => ({
          projects: state.projects.map((project) =>
            project.id === id ? { ...project, products } : project,
          ),
        }));
      },
      ...
      updateProjectDate: async (id, start_date) => {
        ...
        set((state) => ({
          projects: state.projects.map((project) =>
            project.id === id ? { ...project, start_date } : project,
          ),
        }));
      },
