...
interface IModalProps {
  ...
  editSubKeyterm: (id: number, title: string, link: string) => void;
  deleteSubKeyterm: (id: number) => void;
  title: string;
  link: string;
}

export default function SubKeytermModal({
  open,
  id,
  setOpen,
  editSubKeyterm,
              ...
              <div className="flex justify-between">
                <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                  <button
                    ...
                    onClick={() => {
                      deleteSubKeyterm(id);
                      toast.error("SubKeyterm Deleted!", {
                        theme: "colored",
                      });
                      setOpen(false);
                    }}
                ...
                <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                  <button
                    ...
                    onClick={() => {
                      editSubKeyterm(id, newTitle, newLink);
                      toast.success("SubKeyterm Updated!", {
                        theme: "colored",
                      });
                      setOpen(false);
                    }}
