...
interface IModalProps {
  ...
  addSubjournal: (journal_id: number, title: string, link: string) => void;
  journalId: number;
}

export default function AddSubjournalModal({
  open,
  setOpen,
  addSubjournal,
  journalId,
            ...
            <div className="inline-block dark:bg-dark align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button
                  ...
                  onClick={() => {
                    addSubjournal(journalId, newTitle, newLink);
                    toast.success("Subjournal Added!", {
                      theme: "colored",
                    });
                    setOpen(false);
                  }}
                ...
                <button
                  type="button"
                  className="mt-3 w-full inline-flex dark:bg-dark justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
